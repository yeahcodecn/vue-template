<template>
  <div class="container mx-auto px-6 py-8">
    <h3 class="text-gray-700 dark:text-yellow-100 text-3xl font-medium">Dashboard</h3>
    <div class="mt-4">
      <div class="flex flex-wrap -mx-6">
        <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
          <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white dark:bg-slate-900">
            ...
            <div class="mx-5">
              <h4 class="text-2xl font-semibold text-gray-600">8,282</h4>
        ...
        <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
          <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white dark:bg-slate-900">
            ...
            <div class="mx-5">
              <h4 class="text-2xl font-semibold text-gray-600">200,521</h4>
        ...
        <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
          <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white dark:bg-slate-900">
            ...
            <div class="mx-5">
              <h4 class="text-2xl font-semibold text-gray-600">215,542</h4>
    ...
    <div class="flex flex-col mt-8">
      <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
        <div class="align-middle mb-12 inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
          <table class="min-w-full">
            <thead>
              <tr>
                <th class="px-6 py-3 border-b border-gray-200 bg-gray-100 dark:bg-slate-900 text-slate-900 dark:text-white text-left text-xs leading-4 font-medium uppercase tracking-wider">Name</th>
                <th class="px-6 py-3 border-b border-gray-200 bg-gray-100 dark:bg-slate-900 text-slate-900 dark:text-white text-left text-xs leading-4 font-medium uppercase tracking-wider">Title</th>
                <th class="px-6 py-3 border-b border-gray-200 bg-gray-100 dark:bg-slate-900 text-slate-900 dark:text-white text-left text-xs leading-4 font-medium uppercase tracking-wider">Status</th>
                <th class="px-6 py-3 border-b border-gray-200 bg-gray-100 dark:bg-slate-900 text-slate-900 dark:text-white text-left text-xs leading-4 font-medium uppercase tracking-wider">Role</th>
                <th class="px-6 py-3 border-b border-gray-200 bg-gray-100 dark:bg-slate-900 text-slate-900 dark:text-white"></th>
              </tr>
            </thead>

            <tbody class="bg-gray-50 dark:bg-slate-700">
              <tr v-for="i in 8" :key="i.index" class="hover:bg-gray-200 dark:hover:bg-gray-800 hover:shadow-lg transition-transform transform hover:-translate-y-1">
                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                  <div class="flex items-center">
                    ...
                    <div class="ml-4">
                      <div class="text-sm leading-5 font-medium text-slate-700 dark:text-gray-200">John Doe {{ i }}</div>
                      <div class="text-sm leading-5 text-slate-900 dark:text-gray-200">john@example.com</div>
                    </div>
                  </div>
                </td>

                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                  <div class="text-sm leading-5 text-gray-900 dark:text-gray-200">Software Engineer</div>
                  <div class="text-sm leading-5 text-gray-500 dark:text-gray-200">Web dev</div>
                </td>
                ...
                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 text-gray-500 dark:text-gray-200">Owner</td>
