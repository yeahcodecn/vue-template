...
<template>
  ...
  <div class="flex h-screen bg-gray-200" :class="isDark ? 'theme-dark' : 'theme-light'">
    ...
    <!-- 遮罩层 结束-->
    <!-- sidebar 开始-->
    <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="dark:bg-gray-600 fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform xm:bg-gray-900 sm:bg-gray-800 md:bg-gray-900 lg:bg-gray-300 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
      <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
          ...
          <span class="text-white dark:text-white text-2xl mx-2 font-semibold">YeahCodeCn</span>
        </div>
      </div>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      <Header v-model:sidebarOpen="sidebarOpen" @changeDark="change"></Header>
      <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200 dark:bg-slate-700">
